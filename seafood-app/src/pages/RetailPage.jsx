  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          <h1 className="mb-2" style={{ color: '#0A2647' }}>Mua lẻ hải sản</h1>
          ...
          <div className={`${showFilters ? 'block' : 'hidden'} lg:block w-full lg:w-64 flex-shrink-0`}>
            <div className="bg-white rounded-lg shadow-sm p-6 sticky top-20">
              <div className="flex items-center justify-between mb-4">
                <h3 className="flex items-center gap-2" style={{ color: '#0A2647' }}>
              ...
              <div className="space-y-6">
                    ...
                    {['Tất cả', 'Dưới 100.000đ', '100.000đ - 300.000đ', '300.000đ - 500.000đ', 'Trên 500.000đ'].map((range) => (
                      <label key={range} className="flex items-center gap-2 text-sm text-gray-600 cursor-pointer">
                        <input 
                          ...
                          className="text-[#00BCD4] focus:ring-[#00BCD4]" 
                        />
                        {range}
                      </label>
                    ))}
                ...
                <div>
                  ...
                  <select 
                    ...
                    className="w-full p-2 border rounded-md text-sm outline-none focus:ring-1 focus:ring-[#00BCD4]"
                  >
          ...
          <div className="flex-1">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center gap-4">
                <button
                  ...
                  className="lg:hidden flex items-center gap-2 px-4 py-2 border rounded-md text-sm"
            ...
            {filteredProducts.length > 0 ? (
              ...
              <div className="text-center py-20 bg-white rounded-lg shadow-sm">
                <p className="text-gray-400 mb-2">Không tìm thấy sản phẩm nào khớp với bộ lọc.</p>
                <button 
                  onClick={() => {
                    setSelectedCategories([]);
                    setPriceRange('Tất cả');
